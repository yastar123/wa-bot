...
export default function Login() {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col bg-[#f0f2f5] dark:bg-[#111b21] font-sans">
      {/* Header */}
      <header className="bg-white dark:bg-[#202c33] py-4 px-6 md:px-12 flex items-center gap-3">
